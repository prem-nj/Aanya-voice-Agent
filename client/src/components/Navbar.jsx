    ...
    <div className='sticky top-0 z-50 backdrop-blur-xl bg-white/80 border-b border-orange-100'>
      <div className='max-w-7xl mx-auto px-4 sm:px-6 py-3 flex items-center justify-between'>
        ...
        <div onClick={()=>navigate("/")} className='flex items-center gap-2.5'>
          ...
          <h1 className='font-bold text-xl text-gray-700 leading-none'>Anaya{" "}<span className='text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-emerald-500'>AI</span></h1>
